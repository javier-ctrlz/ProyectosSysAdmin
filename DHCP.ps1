...
# 302 IS
# Script Modificado para permitir la configuración personalizada de la máscara de subred y rango DHCP flexible

# Instalar el rol de servidor DHCP (Comentado para ejecución opcional)
